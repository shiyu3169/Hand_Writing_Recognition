...
/**
 * This class cite a class from Gabe Johnson to read the MNIST dataset files.
 */
...
//    public static ArrayList<int[][]> imageArrayList;

    private ArrayList<Double> labelArrayList;
    private ArrayList<int[][]> imageArrayList;

    public MNISTReader() {
        this.labelArrayList = null;
        this.imageArrayList = null;
    }
    public void reader(String labelFile, String dataFile) throws IOException {
        ...
        this.imageArrayList = new ArrayList<int[][]>();
        this.labelArrayList = new ArrayList<Double>();
        ...
        while (labels.available() > 0 && numLabelsRead < numLabels) {
            ...
            int intLabel = label;
            labelArrayList.add(intLabel + 0.0);
            numLabelsRead++;
    ...
    public ArrayList<Double> getLabelArrayList() {
        return this.labelArrayList;
    }

    public ArrayList<int[][]> getImageArrayList() {
